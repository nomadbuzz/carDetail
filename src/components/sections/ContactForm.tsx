      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <select
            id="service"
            {...register("service")}
            className="flex h-11 w-full rounded-lg border border-border bg-card px-4 py-2 text-base sm:text-sm text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
